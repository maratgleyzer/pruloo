...
<?php
	...
	echo renderChart("../../FusionCharts/FCF_Column3D.swf", "Data/Data.xml", "", "chart1", 600, 300, false, false);
?>
	<BR><BR>
<?php	
	//Now, create a Column 2D Chart
	echo renderChart("../../FusionCharts/FCF_Column2D.swf", "Data/Data.xml", "", "chart2", 600, 300, false, false);
?>
	<BR><BR>
<?php	
	//Now, create a Line 2D Chart
	echo renderChart("../../FusionCharts/FCF_Line.swf", "Data/Data.xml", "", "chart3", 600, 300, false, false);
?>
