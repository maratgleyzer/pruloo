...
?><div id="center">
		...
		<form name="new_customers" id="new_customers" method="post" enctype="multipart/form-data" action="edit_prospects.php">
			<input name="act" value="" type="hidden">
			<input name="flag" value="1" type="hidden">
			<input name="p_id" value="2261" type="hidden">
			
						<div class="formBoxSmall">
				<p>

					<label>First Name:</label>
					<span class="right"><input name="FirstName" class="filter_field" value="Eric" type="text"></span>
				</p>
				<p>
					<label>Last Name:</label>
					<span class="right"><input name="LastName" value="Esron" type="text"></span>
				</p>
				<p>

					<label>Address:</label>
					<span class="right"><input name="Address" value="4709 N 66th St Apt 61" type="text"></span>
				</p>
				<p>
					<label>City:</label>
					<span class="right"><input name="City" value="Omaha" type="text"></span>
				</p>
				<p>

					<label>State:</label>
					<span class="right"><input name="State" value="NE" type="text"></span>
				</p>
				<p>
					<label>Zip:</label>
					<span class="right"><input name="Zip" value="68104" type="text"></span>
				</p>
				<p>
				...
				<p>
					<label>Email:</label>
					<span class="right"><input name="UserEmail" value="erryesron@yahoo.co.uk" type="text"></span>
				</p>
				<p>
					<label>Phone:</label>
					<span class="right"><input name="UserPhone" value="4025025904" type="text"></span>
				</p>

				<br><br>
				<p>
					<img src="images/back.png" value="Cancel" alt="Cancel" onclick="window.self.close();" style="cursor: pointer;">
					<img src="images/save.png" value="Edit Prospect" alt="Save" style="cursor: pointer;" onclick="document.new_customers.submit();">
				</p>
			</div>
		</form>
	</div>
